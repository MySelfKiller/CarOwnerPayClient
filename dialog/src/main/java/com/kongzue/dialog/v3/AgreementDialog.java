...
public class AgreementDialog extends BaseDialog {
    ...
    protected AgreementDialog() {
    }
    
    public static AgreementDialog build(@NonNull AppCompatActivity context) {
        synchronized (AgreementDialog.class) {
            AgreementDialog messageDialog = new AgreementDialog();
            ...
            switch (messageDialog.style) {
                case STYLE_IOS:
                    messageDialog.build(messageDialog, R.layout.dialog_select_ios_left);
                    break;
                case STYLE_KONGZUE:
    ...
    public static AgreementDialog show(@NonNull AppCompatActivity context, CharSequence title, CharSequence message) {
        synchronized (AgreementDialog.class) {
            AgreementDialog messageDialog = show(context, title, message, null, null, null);
            return messageDialog;
        }
    }
    
    public static AgreementDialog show(@NonNull AppCompatActivity context, int titleResId, int messageResId) {
        synchronized (AgreementDialog.class) {
            AgreementDialog messageDialog = show(context,
    ...
    public static AgreementDialog show(@NonNull AppCompatActivity context, CharSequence title, CharSequence message, CharSequence okButton) {
        synchronized (AgreementDialog.class) {
            AgreementDialog messageDialog = show(context, title, message, okButton, null, null);
            return messageDialog;
        }
    }
    
    public static AgreementDialog show(@NonNull AppCompatActivity context, int titleResId, int messageResId, int okButtonResId) {
        synchronized (AgreementDialog.class) {
            AgreementDialog messageDialog = show(context,
                    context.getString(titleResId),
                    context.getString(messageResId),
    ...
    public static AgreementDialog show(@NonNull AppCompatActivity context, CharSequence title, CharSequence message, CharSequence okButton, CharSequence cancelButton) {
        synchronized (AgreementDialog.class) {
            AgreementDialog messageDialog = show(context, title, message, okButton, cancelButton, null);
            return messageDialog;
        }
    }
    
    public static AgreementDialog show(@NonNull AppCompatActivity context, int titleResId, int messageResId, int okButtonResId, int cancelButtonResId) {
        synchronized (AgreementDialog.class) {
            AgreementDialog messageDialog = show(
                    context,
                    context.getString(titleResId),
                    context.getString(messageResId),
                    context.getString(okButtonResId),
    ...
    public static AgreementDialog show(@NonNull AppCompatActivity context, CharSequence title, CharSequence message, CharSequence okButton, CharSequence cancelButton, CharSequence otherButton) {
        synchronized (AgreementDialog.class) {
            AgreementDialog messageDialog = build(context);
    ...
    public static AgreementDialog show(@NonNull AppCompatActivity context, int titleResId, int messageResId, int okButtonResId, int cancelButtonResId, int otherButtonResId) {
        synchronized (AgreementDialog.class) {
            AgreementDialog messageDialog = show(
                    context,
                    context.getString(titleResId),
    ...
    public void refreshView() {
        ...
        if (btnSelectPositive != null) {
            if (isNull(okButton)) {
                btnSelectPositive.setVisibility(View.GONE);
                splitHorizontal.setVisibility(View.GONE);
            } else {
                splitHorizontal.setVisibility(View.VISIBLE);
                btnSelectPositive.setVisibility(View.VISIBLE);
                ...
                btnSelectPositive.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        if (onOkButtonClickListener != null) {
                            if (!onOkButtonClickListener.onClick(AgreementDialog.this, v)) {
                                doDismiss();
                            }
                        } else {
                            doDismiss();
                ...
                btnSelectNegative.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        if (onCancelButtonClickListener != null) {
                            if (!onCancelButtonClickListener.onClick(AgreementDialog.this, v)) {
                                doDismiss();
                            }
                        } else {
                            doDismiss();
            ...
            btnSelectOther.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (onOtherButtonClickListener != null) {
                        if (!onOtherButtonClickListener.onClick(AgreementDialog.this, v)) {
                            doDismiss();
                        }
                    } else {
                        doDismiss();
    ...
    public AgreementDialog setTitle(CharSequence title) {
        this.title = title;
        return this;
    }
    
    public AgreementDialog setTitle(int titleResId) {
    ...
    public AgreementDialog setMessage(CharSequence content) {
        this.message = content;
        return this;
    }
    
    public AgreementDialog setMessage(int contentResId) {
    ...
    public AgreementDialog setOkButton(String okButton) {
        this.okButton = okButton;
        refreshView();
        return this;
    }
    
    public AgreementDialog setOkButton(int okButtonResId) {
        setOkButton(context.get().getString(okButtonResId));
        return this;
    }
    
    public AgreementDialog setOkButton(CharSequence okButton, OnDialogButtonClickListener onOkButtonClickListener) {
        this.okButton = okButton;
    ...
    public AgreementDialog setOkButton(int okButtonResId, OnDialogButtonClickListener onOkButtonClickListener) {
        setOkButton(context.get().getString(okButtonResId), onOkButtonClickListener);
        return this;
    }
    
    public AgreementDialog setOkButton(OnDialogButtonClickListener onOkButtonClickListener) {
        this.onOkButtonClickListener = onOkButtonClickListener;
        refreshView();
        return this;
    }
    ...
    public AgreementDialog setCancelButton(CharSequence cancelButton) {
        this.cancelButton = cancelButton;
        refreshView();
        return this;
    }
    
    public AgreementDialog setCancelButton(int cancelButtonResId) {
        setCancelButton(context.get().getString(cancelButtonResId));
        return this;
    }
    
    public AgreementDialog setCancelButton(CharSequence cancelButton, OnDialogButtonClickListener onCancelButtonClickListener) {
        this.cancelButton = cancelButton;
    ...
    public AgreementDialog setCancelButton(int cancelButtonResId, OnDialogButtonClickListener onCancelButtonClickListener) {
        setCancelButton(context.get().getString(cancelButtonResId), onCancelButtonClickListener);
        return this;
    }
    
    public AgreementDialog setCancelButton(OnDialogButtonClickListener onCancelButtonClickListener) {
        this.onCancelButtonClickListener = onCancelButtonClickListener;
        refreshView();
        return this;
    }
    ...
    public AgreementDialog setOtherButton(CharSequence otherButton) {
        this.otherButton = otherButton;
        refreshView();
        return this;
    }
    
    public AgreementDialog setOtherButton(int otherButtonResId) {
        setOtherButton(context.get().getString(otherButtonResId));
        return this;
    }
    
    public AgreementDialog setOtherButton(CharSequence otherButton, OnDialogButtonClickListener onOtherButtonClickListener) {
        this.otherButton = otherButton;
    ...
    public AgreementDialog setOtherButton(int otherButtonResId, OnDialogButtonClickListener onOtherButtonClickListener) {
        setOtherButton(context.get().getString(otherButtonResId), onOtherButtonClickListener);
        return this;
    }
    
    public AgreementDialog setOtherButton(OnDialogButtonClickListener onOtherButtonClickListener) {
        this.onOtherButtonClickListener = onOtherButtonClickListener;
        refreshView();
        return this;
    }
    ...
    public AgreementDialog setOnOkButtonClickListener(OnDialogButtonClickListener onOkButtonClickListener) {
        this.onOkButtonClickListener = onOkButtonClickListener;
        refreshView();
        return this;
    }
    ...
    public AgreementDialog setOnCancelButtonClickListener(OnDialogButtonClickListener onCancelButtonClickListener) {
        this.onCancelButtonClickListener = onCancelButtonClickListener;
        refreshView();
        return this;
    }
    ...
    public AgreementDialog setOnOtherButtonClickListener(OnDialogButtonClickListener onOtherButtonClickListener) {
        this.onOtherButtonClickListener = onOtherButtonClickListener;
        refreshView();
        return this;
    }
    
    public AgreementDialog setOkButtonDrawable(@DrawableRes int okButtonDrawableResId) {
        this.okButtonDrawable = ContextCompat.getDrawable(context.get(), okButtonDrawableResId);
        refreshView();
        return this;
    }
    
    public AgreementDialog setOkButtonDrawable(Drawable okButtonDrawable) {
        this.okButtonDrawable = okButtonDrawable;
        refreshView();
        return this;
    }
    
    public AgreementDialog setCancelButtonDrawable(@DrawableRes int okButtonDrawableResId) {
        this.cancelButtonDrawable = ContextCompat.getDrawable(context.get(), okButtonDrawableResId);
        refreshView();
        return this;
    }
    
    public AgreementDialog setCancelButtonDrawable(Drawable cancelButtonDrawable) {
        this.cancelButtonDrawable = cancelButtonDrawable;
        refreshView();
        return this;
    }
    
    public AgreementDialog setOtherButtonDrawable(@DrawableRes int okButtonDrawableResId) {
        this.otherButtonDrawable = ContextCompat.getDrawable(context.get(), okButtonDrawableResId);
        refreshView();
        return this;
    }
    
    public AgreementDialog setOtherButtonDrawable(Drawable otherButtonDrawable) {
    ...
    public AgreementDialog setButtonOrientation(int buttonOrientation) {
    ...
    public AgreementDialog setOnDismissListener(OnDismissListener onDismissListener) {
    ...
    public AgreementDialog setOnShowListener(OnShowListener onShowListener) {
    ...
    public AgreementDialog setStyle(DialogSettings.STYLE style) {
        if (isAlreadyShown) {
    ...
    public AgreementDialog setTheme(DialogSettings.THEME theme) {
    ...
    public AgreementDialog setCancelable(boolean enable) {
    ...
    public AgreementDialog setTitleTextInfo(TextInfo titleTextInfo) {
    ...
    public AgreementDialog setMessageTextInfo(TextInfo messageTextInfo) {
    ...
    public AgreementDialog setButtonTextInfo(TextInfo buttonTextInfo) {
    ...
    public AgreementDialog setButtonPositiveTextInfo(TextInfo buttonPositiveTextInfo) {
    ...
    public AgreementDialog setBackgroundColor(int backgroundColor) {
    ...
    public AgreementDialog setCustomView(View customView) {
    ...
    public AgreementDialog setCustomView(int customViewLayoutId, OnBindView onBindView) {
    ...
    public interface OnBindView {
        void onBind(AgreementDialog dialog, View v);
    }
    ...
    public AgreementDialog setBackgroundResId(int backgroundResId) {
        this.backgroundResId = backgroundResId;
        refreshView();
        return this;
    }
    
    public AgreementDialog setCustomDialogStyleId(int customDialogStyleId) {
        if (isAlreadyShown) {
            error("必须使用 build(...) 方法创建时，才可以使用 setTheme(...) 来修改对话框主题或风格。");
            return this;
        }
    ...
    public AgreementDialog setOnBackClickListener(OnBackClickListener onBackClickListener) {
    ...
    public AgreementDialog setAlign(ALIGN align) {
        this.align = align;
        return this;
    }
}
