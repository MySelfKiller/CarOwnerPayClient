...
public class RoundTypeImageView extends AppCompatImageView {
    public RoundTypeImageView(final Context context) {
        this(context, null);
    }

    public RoundTypeImageView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public RoundTypeImageView(Context context, AttributeSet attrs, int defStyle) {
