...
public class RefundReasonAdapter extends RecyclerView.Adapter<RefundReasonAdapter.loanHolder> {

    private Context context;
    private List<String> dataList;
    private ItemCallback itemCallback;

    public void addAllData(List<String> dataList, boolean isRemoveAllData) {
    ...
    public RefundReasonAdapter(Context context, List<String> data, ItemCallback itemCallback){
...
//        this.flag = flag;
    ...
    public loanHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(context).inflate(R.layout.item_refund_reason,viewGroup,false);
    ...
    public void onBindViewHolder(@NonNull final loanHolder loanHolder, final int i) {
        String washStationBean = dataList.get(i);
        loanHolder.mode_tv.setText(washStationBean);
//        if (i == 0) {
