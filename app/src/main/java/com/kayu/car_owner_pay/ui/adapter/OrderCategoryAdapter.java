...
public class OrderCategoryAdapter extends RecyclerView.Adapter<OrderCategoryAdapter.MyViewHolder> {
    ...
    public OrderCategoryAdapter(List<List<SysOrderBean>> data, ItemCallback itemCallback){
        dataList = data;
...
//        this.flag = flag;
    ...
    public void addAllData(List<List<SysOrderBean>> dataList) {
...
//        KWApplication.getInstance().loadImg(dataList.get(position).icon,holder.tv_img);
        ...
        OrderCategorySubAdapter categoryAdapter = new OrderCategorySubAdapter(dataList.get(position), new ItemCallback() {
            @Override
